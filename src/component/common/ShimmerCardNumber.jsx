    ...
    <div className="flex flex-wrap items-center justify-center">
      {Array(num)
        ...
        .map((_, index) => (
          <div
            key={index}
            className="md:w-[300px] max-w-[270px] min-h-[350px] p-3 flex flex-col justify-between mx-3 mb-5 md:h-[190px] rounded-lg bg-blue-600 bg-opacity-40 animate-pulse"
          >
