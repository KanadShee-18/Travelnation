...
const SignUpForm = () => {
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col p-8 mt-10 mb-20 rounded-lg shadow-md bg-opacity-35 bg-slate-900 backdrop-blur-lg shadow-slate-950"
    >
      <div className="absolute top-14 -z-10 -right-20 h-[30%] w-[50%] bg-gradient-to-br  from-pink-500 via-blue-500 to-[#cf58ec] rounded-tl-lg rounded-br-md blur-[60px] opacity-45 rounded-bl-xl"></div>
      <div>
        <h1 className="text-4xl font-semibold text-center text-transparent md:text-start font-poppins bg-gradient-to-r from-[#6644ff] via-[#615fff] to-[#ff1f88] drop-shadow-2xl bg-clip-text">
          ...
          <label className="space-y-1">
            ...
            <div className="rounded-md flex flex-row items-center relative shadow-md focus-within:shadow-sm focus-within:shadow-[#595ce0] bg-[#464e7e] bg-opacity-35 shadow-slate-950">
              ...
              <span
                ...
                className="mr-3 absolute right-0 text-xl text-[#ff387a] hover:cursor-pointer"
              >
          ...
          <label className="space-y-1">
            ...
            <div className="rounded-md relative  flex flex-row items-center shadow-md focus-within:shadow-sm focus-within:shadow-[#595ce0] bg-[#464e7e] bg-opacity-35 shadow-slate-950">
              ...
              <span
                ...
                className="mr-3 right-0 absolute text-xl text-[#ff387a] hover:cursor-pointer"
              >
      ...
      <div className="flex flex-row justify-between px-2 mt-5">
        <Link
          to={"/login"}
          className="font-semibold text-xs text-center text-transparent font-poppins bg-gradient-to-r from-[#7455ff] to-[#0bb6c2] bg-clip-text hover:translate-x-2 transition-all duration-200 ease-in-out"
        >
