...
const Sidebar = () => {
  ...
  return (
    <div
      className={`md:relative fixed top-0 left-0 z-30 pt-16 min-h-screen transition-transform duration-300
    ...
    >
      ...
      <button
        ...
        className={`absolute top-20 md:top-4 ${isOpen?"right-4":"-right-7"} p-1 bg-slate-500 text-black rounded-full hover:text-slate-100
