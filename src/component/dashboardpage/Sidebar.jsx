...
//       w-[270px] p-4 text-white backdrop-blur-sm bg-[#2d3244] dark:bg-opacity-75`}
//     >
//       {/* Toggle Button */}
//       <button
...
const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-30 pt-16 h-screen 
      ${isOpen ? "translate-x-0" : "-translate-x-full"} 
      w-[220px] p-4 text-white backdrop-blur-sm bg-[#2d3244] dark:bg-opacity-75
