  ...
  return (
    <div className="relative w-full h-full">
      <div className="grid w-full h-full bg-slate-500">
        {/* Layout for 1 image */}
        {imageCount === 1 && (
          <div className="w-full md:h-[350px] h-[250px]  col-span-1">
            <img
              src={images[0]}
              alt={`Image 1`}
        ...
        {imageCount === 3 && (
          <div className="grid w-full h-full grid-cols-2">
            <div className="md:h-[350px] h-[250px] col-span-1">
              <img
                src={images[0]}
                alt={`Image 1`}
                className="object-cover w-full h-full border-[1px] border-slate-300 cursor-pointer"
            ...
            <div className="grid md:h-[350px] h-[250px] col-span-1 grid-rows-2 ">
