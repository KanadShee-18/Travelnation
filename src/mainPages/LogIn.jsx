...
const LogIn = () => {
    ...
    return (
        <div className="w-screen h-screen mt-10 md:mt-0">
            ...
            {loading ? (
                ...
                >
                    ...
                    <p className="xl:my-6 my-3 text-sm font-medium tracking-wide text-transparent bg-gradient-to-br from-slate-400 to-slate-300 drop-shadow-2xl bg-clip-text text-start">
                        <span className="text-pink-500 text-base">Sign in</span> to
                        explore unique stays, exclusive deals, and make your
                        next trip unforgettable.
                    </p>

                    <form onSubmit={handleOnSubmit} className="px-1 mb-5 mt-3">
                        <div className="flex flex-col pb-10 gap-y-5 place-items-center items-center justify-around py-5 bg-[#5460be] bg-opacity-25 rounded-xl shadow-md shadow-slate-950 w-full m-auto text-[#937aff]">
                            <div className="w-full px-5">
                                <label className="space-y-1">
                                    <p className="text-[15px] tracking-wide text-slate-300 text-start">
                                        Email{" "}
                                        <sup className="text-lg text-pink-500">
                                            *
                                        </sup>{" "}
                                    </p>
                                    <div className="rounded-md shadow-md focus-within:shadow-sm focus-within:shadow-[#595ce0] bg-[#464e7e] bg-opacity-35 shadow-slate-950">
                                        <input
                                            ...
                                            className="w-full text-sm px-3 py-2 rounded-md tracking-wide text-blue-300 text-[15px] placeholder-purple-400 bg-transparent outline-none placeholder-opacity-70 backdrop-blur-lg"
                                        />
                                    </div>
                                </label>
                            </div>
                            <div className="w-full px-5">
                                <label className="space-y-1">
                                    <p className="text-[15px] tracking-wider text-slate-300 text-start">
                                        Password{" "}
                                        <sup className="text-lg text-pink-500">
                                            *
                                        </sup>{" "}
                                    ...
                                    <div className="rounded-md flex items-center relative shadow-md focus-within:shadow-sm focus-within:shadow-[#595ce0] bg-[#464e7e] bg-opacity-35 shadow-slate-950">
                                        <input
                                            ...
                                            className="w-full text-sm px-3 py-2 pr-12 rounded-md tracking-wider text-blue-300 text-[15px] placeholder-purple-400 bg-transparent outline-none placeholder-opacity-70 backdrop-blur-lg"
                                        />
                                        <span
                    ...
                    <div className="flex flex-row justify-between px-2 mt-5">
                        ...
                        >
                            <p className="font-semibold text-center text-xs text-transparent font-poppins bg-gradient-to-r from-[#878fb8] to-[#757ca1] bg-clip-text ">
                                {" "}
